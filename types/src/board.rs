use crate::{bitboard::*, player::Player, r#move::Move};
...
impl Board {
    pub fn is_empty(&self) -> bool {
        self.red.is_empty() && self.yellow.is_empty()
    }
    ...
    // /// Returns all winning moves in the position for the current colour
    // pub fn winning_moves(&self) -> BitBoard {
    //     let colour = match self.turn {
    //         Player::Red => self.red,
    //         Player::Yellow => self.yellow
    //     };
    //     let raised = colour | self.moves();
